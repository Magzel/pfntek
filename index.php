            ...
            if ($wo['user']['is_pro'] != 0 || Wo_IsAdmin()) {
                switch ($page) {
                    ...
                    case 'common_things':
                        ...
                        break;
                        case 'view_post':
                            include('sources/view_post.php');
                            break;
                    case 'reload-chat-list':
                        include('sources/reload-chat-list.php');
                        break;
                    case 'add_chat':
                        include('sources/add_chat.php');
                        break;
                    case 'group-chat':
                        include('sources/group-chat.php');
                        break;
                    case 'edit_groups':
                        include('sources/edit_groups.php');
                        break;
                    case 'chat-rooms':
                        include('sources/chat-rooms.php');
                        break;
                    case 'thankyou':
                        include('sources/thankyou.php');
                        break;
                    case 'feedback':
                        include('sources/feedback.php');
                        break;
                    case 'edit_interest':
                        include('sources/edit_interest.php');
                        break;
                    case 'knkt_follow':
                        include('sources/knkt_follow.php');
                        break;
                    case 'knkt_post':
                        include('sources/knkt_post.php');
                        break;
                    case 'like_post':
                        include('sources/like_post.php');
                        break;
                    case 'edit_post':
                        include('sources/edit_post.php');
                        break;
                    case 'create_comment':
                        include('sources/create_comment.php');
                        break;

                    case 'kntn_catagory':
                        include('sources/kntn_catagory.php');
                        break;

                    case 'kntn_catagory1':
                        include('sources/kntn_catagory1.php');
                        break;
                    case 'funding':
