...
function Wo_OpenMessagesMenuBtn() {
  messages_container = $('.messages-chat-container');
  messages_list_chat = $('#messages-list-four-last');
  $.get(Wo_Ajax_Requests_File(), {
    f: 'get_messages_chat'
  }, function (data) {
    if(data.status == 200) {
      if(data.html.length == 0) {
        messages_list_chat.html('<a class="fab-action fab-action-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M20,2H4A2,2 0 0,0 2,4V22L6,18H20A2,2 0 0,0 22,16V4C22,2.89 21.1,2 20,2Z"></path></svg></a> <a class="fab-action fab-action-2"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M20,2H4A2,2 0 0,0 2,4V22L6,18H20A2,2 0 0,0 22,16V4C22,2.89 21.1,2 20,2Z"></path></svg> </a> <a class="fab-action fab-action-3"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M20,2H4A2,2 0 0,0 2,4V22L6,18H20A2,2 0 0,0 22,16V4C22,2.89 21.1,2 20,2Z"></path></svg> </a> <a class="fab-action fab-action-4"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M20,2H4A2,2 0 0,0 2,4V22L6,18H20A2,2 0 0,0 22,16V4C22,2.89 21.1,2 20,2Z"></path></svg></a>');
      } else {
        //messages_list.html(data.html);
         document.getElementById('messages-list-four-last').innerHTML = data.html;
        $('.open-chat-window').attr("href", data.messages_url);
        //Wo_intervalUpdates();
      }
    }
