        ...
        <div class="navigation">
            ...
            <div class="navigation-menu-body">
                <ul>
                    ...
                    if ($is_admin || ($is_moderoter && ($wo['user']['permission']['changelog'] == 1))) { ?>
                    <li>
                    ...
                    <?php } ?>
                    <?php 
                    if ($is_admin || ($is_moderoter && ($wo['user']['permission']['interest'] == 1))) { 
                        ?>
                    
                    <li>
                        <a <?php echo ($page == 'interest'|| $page == 'edit-interest') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('interest'); ?>">
                            <span class="nav-link-icon">
                                <i class="material-icons">update</i>
                            </span>
                            <span>Knkt Interest</span>
                        </a>
                    </li>
                    <?php } ?>
